...
//             match key {
//                 "DataVersion" => data_version = Some(map.next_value()?),
//                 "Level" => level = Some(map.next_value()?),
//                 _ => return Err(de::Error::unknown_field(key, &["id", "name"])),
//             }
//         }

//         let data_version: u32 = data_version.ok_or_else(|| de::Error::missing_field("id"))?;
...
//             {
//                 let mut data_version = None;
//                 let mut level: Option<de::value::MapAccessDeserializer<A>> = None;
...
//                     unimplemented!();
//                 } else {
//                     let sections = sections.ok_or_else(|| de::Error::missing_field("sections"))?;
//                     Ok(Chunk { sections })
//                 }
//             }
//         }
